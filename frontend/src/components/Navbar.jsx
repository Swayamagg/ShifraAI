    ...
    <div className='sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-orange-100'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between'>
        ...
        {user && (<div className='hidden md:flex items-center gap-3'>
          ...
          <button onClick={()=>navigate("/billing")} className='px-4 py-2 rounded-xl border-orange-100 bg-white text-gray-700 text-sm font-medium shadow-md hover:border-purple-300 transition-all cursor-pointer'>Billing</button>
        ...
        {user && (<button onClick={()=>setMenuOpen(!menuOpen)} className='md:hidden text-gray-600 hover:text-purple-500 transition-colors'>
      ...
      {menuOpen && (
        <div className='md:hidden px-4 pb-4'>
          <div className='rounded-2xl bg-white border border-orange-100 shadow-lg p-4'>
            ...
            <button onClick={()=>{setMenuOpen(false);handleLogout()}} className='mt-4 w-full flex items-center justify-center gap-2 rounded-xl py-2.5 bg-red-50 text-red-500 hover:bg-red-100 transition-colors text-sm font-medium'><FiLogOut size={16}/>Logout</button>
          </div>
        </div>
      )}
    </div>
