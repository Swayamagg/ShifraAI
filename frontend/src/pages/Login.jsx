...
const Login = ({setUser}) => {
    ...
    const features=[
        ...
        },
        {
            ...
            desc:"Navigate page using voice commands."
        },
        {
            icons:<HiOutlineCodeBracket/>,
            title:"Easy Embed",
    ...
    <div className='min-h-screen bg-gradient-to-br from-purple-50 via-white to-emerald-50 overflow-hidden'>
        <div className='max-w-7xl mx-auto px-6 py-16 lg:py-24'>
            <div className='grid lg:grid-cols-2 gap-16 items-center'>
             <div>
                    <div className='inline-flex items-centergap-2 px-4 py-2 rounded-full border border-purple-200 bg-purple-100 text-sm font-medium text-purple-600'>
                        <HiOutlineSparkles/>
                        AI Voice Assitsant Platform
                    </div>
                    ...
                    <p className='mt-8 text-lg leading-8 max-w-2xl text-[#475569]'>Create customizable AI voice assistants that talk, guide users, and integrate into any websites instantly.</p>
                    <button onClick={handleLogin} className='mt-10 h-16 px-8 rounded-2xl bg-gradient-to-br from-purple-500 to-emerald-500 text-lg text-white font-semibold flex items-center gap-4 shadow-[0_20px_80px_rgba(139,92,246,0.25)] hover:scaale-[1.02] transition cursor-pointer'>
             ...
             <div className='relative'>
                ...
                <div className='relative rounded-[40px] border border-black/5 bg-white shadow-[0_20px_80px_rgba(0,0,0,06)] p-8 overflow-hidden'>
                   ...
                   <div className='mt-10 space-y-5'>
                    {features.map(({icons,title,desc},index)=>(
                        <div key={index} className='flex gap-5 rounded-3xl border border-black/5 bg-[#f8fafc] p-5'>
                            ...
                            <div>
                                <h3 className='text-lg font-semibold text-[#081028]'>{title}</h3>
